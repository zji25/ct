...
public abstract class UnaryOperation implements MSExpression {
    ...
    public UnaryOperation(MSExpression first) { this.first = first; }

    protected abstract int apply(int a);
    protected abstract String symbol();

    @Override
    public int evaluate(int x) { return apply(first.evaluate(x)); }

    @Override
    public int evaluate(int x, int y, int z) { return apply(first.evaluate(x, y, z)); }
    ...
    @Override
    public int priority() { return Term.op2priority.get(UNARY); }
    ...
    public boolean equals(Object obj) {
        return obj instanceof UnaryOperation temp && Objects.equals(getClass(), obj.getClass())
